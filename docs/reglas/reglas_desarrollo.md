...
- **El modelo de amenaza completo y el registro de riesgos todavía no existen.** 🚧 Los crea el paso 8 de la adopción (`/ingenieria:seguridad`).
...
- **Ubicación y nombre**: `docs/planes/plan_<conceptos>_<AAAAMMDD>_<HHMM>.md`. 🚧 La carpeta todavía no existe: la crea el paso 4 de la adopción.
...
- **Ubicación y nombre**: `docs/revisiones/walkthrough_<conceptos>_<AAAAMMDD>_<HHMM>.md`. 🚧 La crea el paso 4.
